...
#define ANGULAR_VELOCITY 1.0    // 1.5 
...
#define TB3_UPDATE_EXECUTION    6
#define TB3_REACH_WALL          7
#define TB3_FOLLOW_WALL         8
#define TB3_BACKUP              9
...
class Turtlebot3Drive
{
 ...
 private:
  ...
  // New Variable added
    ...
    double escape_range_2;
    double scan_data_walls[3] = {0,0,0};
